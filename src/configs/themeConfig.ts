...
const templateNameData = Cookies.get('Comapany_info')
const nameData = templateNameData && JSON.parse(templateNameData!)
const themeConfig: ThemeConfig = {
  // ** Layout Configs
  templateName: `${nameData?.company_name}` /* App Name */,
