...
import { BLACK_COLOR, DARK_PAPER_BG_COLOR, MENU_APP_NAME_COLOR, MENU_BACKGROUND_COLOR, MENU_TITLE_COLOR, PRIMARY_COLOR_DARK, PRIMARY_COLOR_LIGHT, PRIMARY_COLOR_MAIN, SECONDARY_COLOR_DARK, SECONDARY_COLOR_LIGHT, SECONDARY_COLOR_MAIN, WHITE_COLOR } from 'src/AppConfig'
...
const DefaultPalette = (mode: PaletteMode, skin: Skin) => {
  ...
  const menuBgColor = MENU_BACKGROUND_COLOR
  const menuAppColor = MENU_APP_NAME_COLOR
  const menuTitleColor = MENU_TITLE_COLOR
