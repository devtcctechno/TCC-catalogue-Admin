...
import { MENU_BACKGROUND_COLOR } from 'src/AppConfig'
...
const Navigation = (props: Props) => {
  ...
  const shadowBgColor = () => {
    if (mode === 'semi-dark') {
      ...
      return `linear-gradient(${MENU_BACKGROUND_COLOR} 5%,${hexToRGBA(
        MENU_BACKGROUND_COLOR,
        0.85
      )} 30%,${hexToRGBA(MENU_BACKGROUND_COLOR, 0.5)} 65%,${hexToRGBA(
        MENU_BACKGROUND_COLOR,
        0.3
      )} 75%,transparent)`
    }
