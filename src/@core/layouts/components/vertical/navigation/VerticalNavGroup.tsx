...
import { MENU_TITLE_COLOR } from 'src/AppConfig'
    ...
    if (mode === 'semi-dark') {
      ...
      return {
        ...
        '&.Mui-selected': {
          ...
          '& .MuiTypography-root, & :not(.menu-item-meta) > svg': {
            color: `rgba(${MENU_TITLE_COLOR}, 0.87)`
          },
          '& .menu-item-meta > svg': {
            color: `rgba(${MENU_TITLE_COLOR}, 0.6)`
          }
              ...
              <Box
                ...
                sx={{
                  ...
                  '& svg': {
                    ...
                    color: mode === 'semi-dark' ? `rgba(${theme.palette.customColors.dark}, 0.38)` : `rgba(${theme.palette.customColors.dark}, 0.38)`,
