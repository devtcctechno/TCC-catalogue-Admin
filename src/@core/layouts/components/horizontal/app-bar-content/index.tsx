...
// import fevicon from 'public/images/';
    ...
    <Box sx={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      {userAppBarBranding ? (
        ...
        <LinkStyled href='/'>
          ...
          {/* <svg width={32} height={22} viewBox="0 0 2741 1604" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <img src={`${process.env.NEXT_PUBLIC_IMG_ENDPOINT}/${finalKeyData?.dark_image_path}`} alt={""} />
