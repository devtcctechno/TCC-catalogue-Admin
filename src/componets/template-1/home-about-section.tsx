...
import { appErrors, IMAGE_FIELD_REQUIRED, SEARCH_DELAY_TIME } from 'src/AppConstants'
...
const HomeAboutSection = () => {
    ...
    const getAllMainHomeAboutDataApi = async () => {
        try {
            ...
            if (data.code === 200 || data.code === "200") {
                console.log(data.data[0].sort_title)
    ...
    const handleChangePerPageRows = (perPageRows: any) => {
        getAllHomeAboutDataApi({ ...pagination, per_page_rows: perPageRows.pageSize, current_page: perPageRows.page + 1 })
    }
