...
const CategoryMaster = () => {
  ...
  const addCategoryData = async (data: any) => {
    ...
    sizeChecked && itemSize.map((value: any, index) => formData.append(`id_size[${index}]`, value.id || ""))
    lengthChecked && itemLength.map((value: any, index) => formData.append(`id_length[${index}]`, value.id || ""))
  ...
  const editCategoryData = async (data: any) => {
    ...
    formData.append("is_size", sizeChecked ? '1' : '0')
    formData.append("is_length", lengthChecked ? '1' : '0')
    itemSize.map((value: any, index) => formData.append(`id_size[${index}]`, value?.id || ""))
    itemLength.map((value: any, index) => formData.append(`id_length[${index}]`, value?.id || ""))
    parentCategoryId && formData.append("parent_id", parentCategoryId)
