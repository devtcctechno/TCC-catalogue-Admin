// ** MUI Imports
import { CardContent, Divider, CardHeader, Grid, Card, Drawer, Typography, IconButton, Button, TextField, FormHelperText, } from '@mui/material'
...
import { appErrors, decryptRequestData, FIELD_REQUIRED, SEARCH_DELAY_TIME } from 'src/AppConstants'
    ...
    const handleSubmit = () => {
        if (dialogTitle === "Add") {
            if (title === "") {
                ...
                setContentError(`${FIELD_REQUIRED}`)
            } else if (buttonName === "") {
                setButtonNameError(`${FIELD_REQUIRED}`)
            }
                ...
                <Box sx={{ p: theme => theme.spacing(0, 6, 6) }}>
                    <form>
                        <TccInput
                            ...
                            sx={{ mb: 4 }}
                        />
                        {titleError && <FormHelperText sx={{ color: 'error.main', mt: "-15px", mb: "5px", ml: "15px" }}>{titleError}</FormHelperText>}
                        ...
                        <TccInput
                            ...
                            sx={{ mb: 4 }}
                        />
                        {contentError && <FormHelperText sx={{ color: 'error.main', mt: "-15px", mb: "5px", ml: "15px" }}>{contentError}</FormHelperText>}
                        ...
                        <TccInput
                            ...
                            sx={{ mb: 4 }}
                        />
                        {buttonNameError && <FormHelperText sx={{ color: 'error.main', mt: "-15px", mb: "5px", ml: "15px" }}>{buttonNameError}</FormHelperText>}
