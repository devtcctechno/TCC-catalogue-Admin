...
import { FORGOT_PASSWORD } from 'src/services/AdminServices'
...
const ForgotPassword = () => {
  ...
  const [useEmailData, setUserEmailData] = useState('')
        ...
        <Card>
          <CardContent sx={{ p: theme => `${theme.spacing(10.5, 8, 8)} !important` }}>
            <Box sx={{ mb: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <img src={`${process.env.NEXT_PUBLIC_IMG_ENDPOINT}/${finalKeyData?.dark_image_path}`} height={60} alt="logo image" />
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              <TextField
                ...
                onChange={(e: any) => setUserEmailData(e.target.value)}
              />
              <Button fullWidth type='submit' variant='contained' sx={{ mb: 4 }} onClick={forgotPasswordApi}>
                Send reset link
              </Button>
