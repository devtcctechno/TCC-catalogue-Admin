...
import { CONFIG_PRODUCT, CONFIG_PRODUCT_DELETE, GET_ALL_THREESTONECONFIGPRODUCT } from 'src/services/AdminServices'
import Router from 'next/router'



const threesoneConfigurator = () => {
    ...
    const getAllApi = async (mbPagination: ICommonPagination) => {
        try {
            const data = await GET_ALL_THREESTONECONFIGPRODUCT(mbPagination);
    ...
    return (
        <Grid container spacing={6}>
            ...
            <Grid item xs={12}>
                <Card>
                    <CardHeader title='Threestone Configurator Product'></CardHeader>
                    <Divider />
                    <Box>
...
export default threesoneConfigurator;